...
ALLOWED_HOSTS = ['django-ecommerce-env.eba-qg3gt9cf.us-west-2.elasticbeanstalk.com']
...
# SESSION_EXPIRE_SECONDS = 60  # 1 hour# session timeout
...
TEMPLATES = [
    {
        ...
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [#if u want to specify links which is going to display dynamically
